...
if condition_anchor in interp:
    interp = interp.replace(condition_anchor, condition_replacement, 1)
elif "case 0xa: return cpu->pf" not in interp:
