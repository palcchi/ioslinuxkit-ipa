> **Provenance:** Historical performance report generated by the old `ish-arm64` x86-vs-ARM64 benchmark harness on 2026-04-18. It moved from `benchmark/` to `docs/benchmark/` in May 2026 and to this reports directory in July 2026; the x86 comparison harness has since been retired from the ARM64-only tree.
>
